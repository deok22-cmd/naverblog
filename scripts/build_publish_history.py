...
CAT = {
    ...
    "pass": "교통요금·환급",  # 2026-09-13 신설 (§04 로테이션)
    "hot": "이슈·시즌",  # 2026-09-16b 신설 — 날짜 확정 이슈 레인 (생활정보.md §06)
    # 2026-09-16 🧪 스프린트 A (카테고리_포트폴리오.md)
    "labor": "노무·직장", "lease": "임대차·이사", "ins": "보험청구", "repair": "집수리",
    # 발굴 대기열 — 투입 시 바로 집계되도록 미리 등록
    "biz": "자영업실무", "tax": "세금·환급", "telecom": "통신요금", "law": "법률생활",
    "card": "카드혜택", "edu": "자격증·시험", "wed": "결혼·출산", "pet": "반려동물", "med": "검진·병원",
    "gov": "지원금", "appli": "계절가전(폐지)", "cert": "증명서(폐지)",
